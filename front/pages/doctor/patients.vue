...
function editPaciente(row: any) {
  toast({
    ...
    description: `Não tens permissão para editar o paciente ${row.nome}.`,
    variant: "destructive",
  });
}

function deletePaciente(row: any) {
  toast({
    title: "Eliminar Paciente",
    description: `Não tens permissão para eliminar o paciente ${row.nome}.`,
    variant: "destructive",
  });
}
